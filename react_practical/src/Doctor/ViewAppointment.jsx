...
import { FaUserInjured, FaPhone, FaCalendarAlt, FaClock, FaMoneyBillWave, FaCheck, FaTimes, FaPrescriptionBottleAlt, FaEye, FaPills, FaPlus } from 'react-icons/fa';
    ...
    <div className="container mt-4">
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          ...
          <div>
            <h2 style={{ margin: '0', fontWeight: '700', fontSize: '28px' }}>Appointments Management</h2>
            <p style={{ margin: '5px 0 0 0', opacity: 0.9, fontSize: '15px' }}>View and manage patient appointments</p>
          </div>
        </div>
      </div>
      ...
      <Card style={{
        ...
        {appointments.length > 0 ? (
            ...
            <thead style={{
              ...
              <tr>
                <th style={{ padding: '15px', fontWeight: '600', border: 'none' }}>
                  <FaUserInjured style={{ marginRight: '8px' }} />Patient
                </th>
                <th style={{ padding: '15px', fontWeight: '600', border: 'none' }}>
                ...
                <th style={{ padding: '15px', fontWeight: '600', border: 'none' }}>
                  <FaMoneyBillWave style={{ marginRight: '8px' }} />Payment
                </th>
                ...
                <tr key={appt.id} className="appointment-row">
                  ...
                  <td style={{ padding: '15px', verticalAlign: 'middle', color: '#495057' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <FaCalendarAlt style={{ color: '#0d6efd', fontSize: '14px' }} />
                      {appt.date}
                    </div>
                  </td>
                  <td style={{ padding: '15px', verticalAlign: 'middle', color: '#495057' }}>
                  ...
                  <td style={{ padding: '15px', verticalAlign: 'middle' }}>
                    <div style={{
                      ...
                      <div style={{ fontWeight: '600', marginBottom: '2px' }}>{appt.paymentMethod}</div>
                      <div style={{ fontSize: '11px', color: '#6c757d' }}>{appt.razorpayId}</div>
                    </div>
                  </td>
                  <td style={{ padding: '15px', verticalAlign: 'middle' }}>
          ...
          <div style={{ textAlign: 'center', padding: '60px 20px' }}>
            <MdEventNote style={{ fontSize: '60px', color: '#d0d0d0', marginBottom: '15px' }} />
            <p style={{ color: '#6c757d', fontSize: '16px', margin: 0 }}>No appointments found.</p>
          </div>
        )}
      </Card>
          ...
          <Form>
            ...
            {medicines.length > 0 && (
              <div style={{
                ...
                <h6 style={{ fontWeight: '600', color: '#2c3e50', marginBottom: '12px' }}>
                ...
                {medicines.map((med, index) => (
                  <div key={index} style={{
                    ...
                    <span style={{ color: '#6c757d' }}>- {med.dosage}, {med.mealTiming}</span>
                  </div>
                ))}
              </div>
            )}
            ...
            {/* Dosage Frequency */}
            <Form.Group className="mb-3">
              <Form.Label style={{ fontWeight: '600', color: '#2c3e50' }}>Dosage Frequency</Form.Label>
              <Form.Control 
                as="select" 
            ...
            {/* Meal Timing */}
            <Form.Group className="mb-3">
              <Form.Label style={{ fontWeight: '600', color: '#2c3e50' }}>Meal Timing</Form.Label>
              <Form.Control 
                as="select" 
                value={newMedicine.mealTiming} 
                onChange={(e) => setNewMedicine({ ...newMedicine, mealTiming: e.target.value })}
                style={{
                  padding: '12px',
                  borderRadius: '10px',
                  border: '2px solid #e0e0e0',
