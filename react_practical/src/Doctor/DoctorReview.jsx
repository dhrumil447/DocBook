      ...
      try {
        ...
        const approvedReviews = res.data.filter(
          (review) =>
            ...
            (review.doctor_id || review.doctorId) === doctorId,
        );
        setReviews(approvedReviews);
        calculateAverageRating(approvedReviews);
      } catch (err) {
  ...
  return (
    <Container className="mt-4">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
          ...
          <div>
            ...
            <p style={{ margin: "5px 0 0 0", opacity: 0.9, fontSize: "15px" }}>
              Feedback from your valued patients
            </p>
            <div style={{ marginTop: "10px", display: "flex", alignItems: "center", gap: "10px" }}>
              <span style={{ fontSize: "18px", fontWeight: "bold", color: "#ffc107" }}>
                Average Rating: {averageRating.toFixed(1)} ⭐
              </span>
              <span style={{ fontSize: "14px", color: "white", opacity: 0.8 }}>
      ...
      {reviews.length === 0 ? (
        ...
        >
          <MdRateReview
            style={{ fontSize: "60px", color: "#d0d0d0", marginBottom: "15px" }}
          />
                  ...
                  <td style={{ padding: "15px", verticalAlign: "middle" }}>
                    ...
                    >
                      ...
                      <span style={{ fontWeight: "600", color: "#2c3e50" }}>
                        {getPatientName(review.patient_id || review.patientId)}
                      </span>
                    </div>
                  </td>
                  <td style={{ padding: "15px", verticalAlign: "middle" }}>
