...
import { FaSearch, FaUserInjured, FaEye, FaPills, FaCalendarAlt, FaClock, FaFileAlt } from 'react-icons/fa';
    ...
    <div className="container mt-4">
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          ...
          <div>
            <h2 style={{ margin: '0', fontWeight: '700', fontSize: '28px' }}>Patient Records</h2>
            <p style={{ margin: '5px 0 0 0', opacity: 0.9, fontSize: '15px' }}>View and manage your patient history</p>
          </div>
        </div>
      </div>
          ...
          <thead style={{
            ...
            <tr>
              <th style={{ padding: '15px', fontWeight: '600', border: 'none' }}>
                <FaUserInjured style={{ marginRight: '8px' }} />Patient Name
              </th>
            ...
            {filteredPatients.length > 0 ? (
              ...
              <tr>
                <td colSpan="3" style={{ textAlign: 'center', padding: '40px', color: '#6c757d' }}>
                  <FaUserInjured style={{ fontSize: '40px', marginBottom: '10px', opacity: 0.5 }} />
        ...
        <Modal.Body style={{ padding: '25px' }}>
          {prescriptions.length ? (
              ...
              <Card key={index} style={{
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '8px' }}>
                    ...
                    <h5 style={{ margin: 0, fontWeight: '600' }}>{prescription.appointmentDate}</h5>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', opacity: 0.9 }}>
                    <FaClock style={{ fontSize: '16px' }} />
                    <span style={{ fontSize: '15px' }}>{prescription.appointmentTime}</span>
                  </div>
                </div>
                ...
                <div style={{ padding: '20px' }}>
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                      <FaFileAlt style={{ color: '#0d6efd', fontSize: '18px' }} />
                      <strong style={{ color: '#2c3e50' }}>Description:</strong>
                    </div>
                    <p style={{ margin: 0, color: '#6c757d', paddingLeft: '26px' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <FaCalendarAlt style={{ color: '#fd7e14', fontSize: '18px' }} />
                      <strong style={{ color: '#2c3e50' }}>Next Appointment:</strong>
                      <span style={{ color: '#6c757d', marginLeft: '5px' }}>
                        {prescription.nextAppointmentDate ? moment(prescription.nextAppointmentDate).format("DD-MM-YYYY") : "Not Scheduled"}
                      </span>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                    ...
                    <h6 style={{ margin: 0, fontWeight: '600', color: '#2c3e50' }}>Prescribed Medicines</h6>
                  </div>
                  <Table hover style={{ marginBottom: 0, fontSize: '14px' }}>
                    <thead style={{ background: '#f8f9fa' }}>
                      <tr>
                        <th style={{ padding: '12px', fontWeight: '600', color: '#2c3e50' }}>Name</th>
                        <th style={{ padding: '12px', fontWeight: '600', color: '#2c3e50' }}>Dosage</th>
                        <th style={{ padding: '12px', fontWeight: '600', color: '#2c3e50' }}>Meal Timing</th>
                      </tr>
                    </thead>
                    <tbody>
                      {prescription.medicines.map((med, idx) => (
                        <tr key={idx}>
                          <td style={{ padding: '12px', color: '#495057' }}>{med.name}</td>
            ...
            <div style={{ textAlign: 'center', padding: '40px' }}>
              <FaFileAlt style={{ fontSize: '50px', color: '#d0d0d0', marginBottom: '15px' }} />
              <p style={{ color: '#6c757d', margin: 0 }}>No reports found for this patient.</p>
            </div>
          )}
        </Modal.Body>
      </Modal>
